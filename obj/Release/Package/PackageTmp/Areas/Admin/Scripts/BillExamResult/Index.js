...
function bindIngfo(page) {
    ...
    $.ajax({
        ...
        url: '/Admin/BillExamResult/GetList',
...
function bindSchool() {
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Admin/BillExamResult/GetSchool',
        async: false,
...
function bindTeam() {
    ...
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Admin/BillExamResult/GetTeam' + wheres,
        async: false,
        success: function (data) {
...
function See(Eid, Pid, Mid) {
    window.open("/Bill_Competition/ScoreDetails?ExamId=" + Eid + "&PaperId=" + Pid + "&UIds=" + Mid + "&Type=4");
}
...
function ExportExamResult() {
    ...
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Admin/BillExamResult/ExportExamResult',
