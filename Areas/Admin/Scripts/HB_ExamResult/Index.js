...
function bindSchool() {
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Admin/HB_ExamResult/GetSchool',
        async: false,
...
function bindTeam() {
    ...
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Admin/HB_ExamResult/GetTeam' + wheres,
        async: false,
        success: function (data) {
...
function See(Eid, Pid, Mid) {
    window.open('/HB_ExamPreview?Eid=' + Eid + '&Pid=' + Pid + '&Mid=' + Mid + '&Type=2');
}
